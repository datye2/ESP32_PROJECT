...
document.addEventListener('DOMContentLoaded', function () {
  ...
  socket.addEventListener('open', function (event) {
    ...
    // Bắt đầu gửi giá trị liên tục ngay khi kết nối được mở
    sendServoValues(); // Gửi giá trị ban đầu
    setInterval(sendServoValues, 50); // Gửi giá trị mỗi 100 mili giây (0.1 giây)
  });
  ...
  function sendServoValues() {
    servoValue1 = document.getElementById('slider').value;
    servoValue2 = document.getElementById('slider2').value;
